...
/*
  ...
  create code that will check if Amy or Brittani 
  is older, and then console.log '{name} is older'. 
...
/*
  Using an if statement and a comparison operator, create code that will check if 
  Amy and Brittani were born in the same year. If they were, 
...
/*
  ...
  suggestion on what type of clothes one should wear for the day, 
  based on the above temperature and rain.
  If it is 80 degrees or above, and raining, one should wear a t-shirt 
  and take an umbrella. If it is between 60 and 80 degrees, and raining, 
  one should wear a rain-jacket. If it is 60 degrees or below, one should 
  wear a jacket and carry an umbrella. Come up with your own clothing suggestions 
...
//After you change the value of changeMyMind, console.log it's new value (it should 
 // now read true). 
changeMyMind != true
console.log(changeMyMind)
//CODE HERE
